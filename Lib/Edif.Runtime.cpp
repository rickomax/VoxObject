...
void Edif::Runtime::WriteGlobal(mv * mV, CRunApp * App, const TCHAR * Name, void * Value, HINSTANCE hinst)
{
	EdifGlobal * Global = (EdifGlobal *) mV->mvGetExtUserData(App, hinst);
...
void Edif::Runtime::WriteGlobal(const TCHAR * Name, void * Value)
{
	...
	WriteGlobal(rhPtr->rh4.rh4Mv, rhPtr->rhApp, Name, Value, hInstLib);
}

void * Edif::Runtime::ReadGlobal(mv * mV, CRunApp * App, const TCHAR * Name, HINSTANCE hinst)
{
	EdifGlobal * Global = (EdifGlobal *) mV->mvGetExtUserData(App, hinst);
...
void * Edif::Runtime::ReadGlobal(const TCHAR * Name)
{
	...
	return ReadGlobal(rhPtr->rh4.rh4Mv, rhPtr->rhApp, Name, hInstLib);
}
