...
#ifndef RUN_ONLY
BOOL CALLBACK SetupProcParam(HWND hDlg, UINT msgType, WPARAM wParam, LPARAM lParam)
{
	paramExt*			pExt;
...
void MMF2Func EditParameter(mv _far *mV, short code, paramExt* pExt)
{
	...
	// Example
	// -------
	 DialogBoxParam(hInstLib, MAKEINTRESOURCE(IDD_EDIT), mV->mvHEditWin, SetupProcParam, (LPARAM)(LPBYTE)pExt);
#endif
}
