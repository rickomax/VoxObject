...
namespace Edif
{
	...
	public:
		...
		static void WriteGlobal(mv * mV, CRunApp * App, const TCHAR * Name, void * Value, HINSTANCE hinst);
		static void * ReadGlobal(mv * mV, CRunApp * App, const TCHAR * Name, HINSTANCE hinst);
